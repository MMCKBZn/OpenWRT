...
[![License](https://img.shields.io/github/license/MMCKBZn/OpenWRT)](LICENSE)
...
- 编译大概需要 1-2 小时，编译完成后在仓库主页 [Releases](https://github.com/MMCKBZn/OpenWRT/releases) 对应 Tag 标签内下载固件。
